...
<html>
	<head>
		...
		<link rel='stylesheet' id='install-css' href='http://wpseek.com/source/wp/latest/wp-admin/css/install.min.css.source.txt' type='text/css' media='all' />
		<link rel='stylesheet' id='buttons-css' href='http://wpseek.com/source/wp/latest/wp-includes/css/buttons.min.css.source.txt' type='text/css' media='all' />
		<style type="text/css">
#logo a {
...
<div step="more">
	...
	<form onsubmit="return wp_install.submit()"><table class="form-table">
		<tr>
